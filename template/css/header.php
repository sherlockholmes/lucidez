                    ...
                    <div class="span12">
                        <?php 
                            function mostrar_fecha_actual() {
                                ...
                                return $dias[date('w')].", ".date('d')." de ".$meses[date('n')-1]. " | ".date('h:i:s A') ;
                            }
                        ?>
                        <span class="fecha-portada"><?= mostrar_fecha_actual() ?></span>
                         <div class="right-inner-addon ">
                                <i class="icon-search-boostrap"></i>
                        ...
                        <ul class="nav">
                            <?php 
                                $menu_opciones = array(
                                    ...
                                    'depth'             => -1,
                                    'container'         => false,
                                    'items_wrap'        => '<li id="%1$s"><a href="#">%3$s</a></li>',
                                    'theme_location'    => ''
                                );

                                wp_nav_menu( $menu_opciones ); 
                            ?>
                        </ul>
                    </div>
                    <!--/.nav-collapse -->
